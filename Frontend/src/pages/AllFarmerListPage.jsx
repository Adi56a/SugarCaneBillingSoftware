...
const AllFarmerListPage = () => {
  ...
  : `https://gpckvdmnijhbdwvcmy5u5ul2yy0vzjgc.lambda-url.ap-south-1.on.aws/api/farmer/delete/${farmerId}`;
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      const baseUrl = process.env.NODE_ENV === 'development' 
        ...
        : 'https://gpckvdmnijhbdwvcmy5u5ul2yy0vzjgc.lambda-url.ap-south-1.on.aws/api/farmer/bulk-delete';
